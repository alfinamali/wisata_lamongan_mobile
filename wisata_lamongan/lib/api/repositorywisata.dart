...
class RepositoryWisata {
  final baseUrl = 'http://192.168.1.102:8000/api/wisata';
  ...
  String getImageUrl(String filename) {
    return Uri.parse('http://192.168.1.102:8000/api/file/$filename')
        .toString(); // Include the base URL when constructing the image URL
  }
}

class RepositoryReligi {
  final baseUrl = 'http://192.168.1.102:8000/api/religi';
...
class RepositoryAlam {
  final baseUrl = 'http://192.168.1.102:8000/api/alam';
...
class RepositoryUmkm {
  final baseUrl = 'http://192.168.1.102:8000/api/umkm';
